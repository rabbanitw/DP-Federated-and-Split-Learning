...
mpirun -np 8 python train_mpi.py --description VanillaDecen --resSize 50 --randomSeed 9001 --datasetRoot ./data --budget 0.5 --outputFolder OutputDecenPure200 --bs 64 --epoch 200 --name VanillaDecenPure
