...
mpirun -np 4 python train_mpi.py --description Matcha --resSize 50 --randomSeed 9001 --datasetRoot ./data --budget 0.5 --outputFolder Output --bs 64 --epoch 1 --name trial
